...
const DashboardItem:React.FC<DashboardItemProps> = ({icon, title, size, onEdit, onDelete}) => {
  return (
    <div className={`flex justify-between items-center px-6 w-full bg-[#fafafa] rounded-md focus:outline-none shadow-sm transition duration-100 cursor-default ${size === "sm" ? "text-xs py-1" : "py-3"}`}>
        <div>
