...
function Sidebar() {
  ...
  return (
    <div className="space-y-2 max-w-lg" style={{minWidth: 300}}>
      {/* Top */}
      <div className="bg-white dark:bg-[#1D2226] rounded-lg overflow-hidden relative flex flex-col items-center text-center border border-gray-300 dark:border-none">
        <div className="relative w-full h-14">
          <Image alt="profile" src="https://rb.gy/i26zak" layout="fill" priority />
        </div>
        {/* @ts-ignore */}
        <Avatar
          onClick={signOut}
...
{/* 
          ...
          <div className="sidebarButton flex items-center space-x-1.5">
            ...
            <h4 className="dark:text-white font-medium">Home</h4>
          </div>
          <div className="sidebarButton flex items-center space-x-1.5">
            <BookmarkOutlinedIcon className="!-ml-1" />
            <h4 className="dark:text-white font-medium">Subjects</h4>
          </div>
          <div className="sidebarButton flex items-center space-x-1.5">
            <BookmarkOutlinedIcon className="!-ml-1" />
            <h4 className="dark:text-white font-medium">Messages</h4>
          </div>
          <div className="sidebarButton flex items-center space-x-1.5">
            <BookmarkOutlinedIcon className="!-ml-1" />
            <h4 className="dark:text-white font-medium">Archives</h4>
          </div>
        </div>
      </div>
      {/* Bottom */}
