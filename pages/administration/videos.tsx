                    ...
                    <div className="my-8 col-span-3 px-4">
                        <div>
                            ...
                            <div className="my-6 flex flex-col gap-4 mt-10">
                                <DashboardItem icon="dashicons:video-alt3" title="Test du livre" />
                                <DashboardItem icon="dashicons:video-alt3" title="Test des livres" />
                                <DashboardItem icon="dashicons:video-alt3" title="Livre de tes" />
                            </div>
                        </div>
                    </div>
                </div>
